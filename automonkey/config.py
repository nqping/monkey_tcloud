...
class DefaultConfig(object):
    ...
    TCLOUD_URL = 'http://10.128.208.58:8085/v1/monkey'  # Tcloud 对应的地址,可以作为参数传入

    OSS_URL = 'http://10.128.208.58:8085/static'  # OSS url

    OSS_MONKEY_URL = 'http://10.128.208.58:8085/static/report'  # monkey oss url 存储报告地址
